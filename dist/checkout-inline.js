...
`,key:"ussd"}],_=[{name:"First City Monument Bank",code:"*329#"},{name:"First Bank",code:"*268#"}],x=[{name:"MasterCard",icon:`<svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;class a1{constructor(){c(this,"contents");c(this,"banks");c(this,"_currentStep");this.contents=document.querySelectorAll(".content"),this.banks=_,this._currentStep=1,this.renderUssdContent()}get currentStep(){return this._currentStep}set currentStep(e){this._currentStep=e,this.renderUssdContent()}getUssdStepContent(){switch(this.currentStep){case 1:return D;case 2:return i1;case 3:return M;case 4:return B;default:return D}}renderUssdContent(){this.contents[2]&&(this.contents[2].innerHTML=this.getUssdStepContent())}renderSearchOptions(e,t,o){o.innerHTML="",e.forEach(n=>{const r=document.createElement("div");r.classList.add("bank-option"),r.textContent=n.name,r.addEventListener("click",()=>{t.value=n.name,o.style.display="none"}),o.appendChild(r)}),o.style.display=e.length?"block":"none"}searchBanksOnInput(e,t){const o=e.value.toLowerCase(),n=this.banks.filter(r=>r.name.toLowerCase().includes(o));this.renderSearchOptions(n,e,t)}openSearchOnFocus(e,t){this.renderSearchOptions(this.banks,e,t)}closeSearchOptionsOutsideFocus(e,t,o){!t.contains(e.target)&&!o.contains(e.target)&&(o.style.display="none")}}class s1{constructor(e,t,o){c(this,"modalContainer");c(this,"currentPaymentMethod");c(this,"currentStep");c(this,"container");c(this,"card");c(this,"transfer");c(this,"ussd");c(this,"merchantKey");c(this,"email");c(this,"amount");c(this,"isMobile",!1);if(this.modalContainer=document.createElement("div"),this.modalContainer.innerHTML=g,document.body.appendChild(this.modalContainer),this.isMobile=window.matchMedia("(max-width: 767px)").matches,this.currentPaymentMethod=this.isMobile?3:0,this.currentStep=1,this.container=document.querySelectorAll(".content")[0],this.merchantKey=e,this.email=t,this.amount=o,this.attachInputListeners(),this.switchTab=this.switchTab.bind(this),e===""||t==="")throw this.closeModal(),new Error("Merchant key or email is required")}attachInputListeners(){const e=document.body.querySelector("#change-method"),t=document.body.querySelectorAll(".close-btn"),o=document.querySelector("#mob-container"),n=document.querySelector("#mob-tab-co"),r=document.querySelector("#mob-tab-c");e&&(this.cleanup(),e.addEventListener("click",()=>{this.currentPaymentMethod=3,this.attachInputListeners(),o&&(o.innerHTML=this.mobileContainerContent()),this.setup(),n&&r&&r.parentNode&&n.removeChild(r)})),t.length>0&&t.forEach(i=>{i.addEventListener("click",()=>{this.cleanup(),this.closeModal()})})}displayTabLayout(){const e=document.querySelectorAll(".tab-button"),t=document.querySelectorAll(".mob-tab-button"),o=document.querySelector(".box-container-method"),n=document.querySelector("#mob-container"),r=document.querySelector("#inner-mob-container"),i=document.querySelector("#mob-tab-co");this.isMobile?t&&o&&n&&r&&t.forEach(A=>{A.addEventListener("click",s=>{if(s.currentTarget instanceof HTMLElement&&s.currentTarget.dataset.tab){const l=parseInt(s.currentTarget.dataset.tab);this.updatePaymentMethodView(this.merchantKey,this.email,this.amount),this.setCurrentPaymentMethod(l),n.removeChild(r),this.cleanup(),v.forEach((d,w)=>{this.currentPaymentMethod===w&&i&&(i.innerHTML=`
                      ...
                      `)}),this.renderPaymentMethodContent(),this.attachInputListeners()}})}):e&&o&&e.forEach(A=>{A.addEventListener("click",s=>{if(s.currentTarget instanceof HTMLElement&&s.currentTarget.dataset.tab){const l=parseInt(s.currentTarget.dataset.tab);this.switchTab(l)}})}),this.updatePaymentMethodView(this.merchantKey,this.email,this.amount),this.renderPaymentMethodContent(),this.attachInputListeners(),this.setCurrentPaymentMethod(this.currentPaymentMethod)}updatePaymentMethodView(e,t,o){switch(this.currentPaymentMethod){case 0:return this.card=new G(this.modalContainer,()=>this.closeModal(),e,t,o,()=>this.switchTab(1));case 1:return this.transfer=new r1(this.modalContainer,()=>this.closeModal(),e,t,o);case 2:return this.ussd=new a1;default:return this.card=new G(this.modalContainer,()=>this.closeModal(),e,t,o,()=>this.switchTab(1))}}renderPaymentMethodContent(){return(()=>{switch(this.currentPaymentMethod){case 0:return this.card.renderCardContent();case 1:return this.transfer.renderTransferContent();case 2:return this.ussd.renderUssdContent();case 3:return"";default:return this.card.renderCardContent()}})()}setCurrentPaymentMethod(e){this.currentPaymentMethod=e;const t=document.querySelectorAll(".tab-button");let o=document.querySelectorAll(".content");const n=document.getElementById("mob-action-btns");t.forEach(r=>r.classList.remove("active")),o.forEach(r=>r.classList.remove("active")),t[e]&&t[e].classList.add("active"),o[e]&&o[e].classList.add("active"),e!==3&&n&&(n.classList.remove("hidden"),n.classList.add("md:hidden"))}switchTab(e){this.setCurrentPaymentMethod(e),this.updatePaymentMethodView(this.merchantKey,this.email,this.amount),this.cleanup(),this.renderPaymentMethodContent(),this.attachInputListeners()}setup(){const e=document.getElementById("merchantLogo"),t=document.getElementById("merchantLogoMob"),o=document.getElementById("mob-action-btns"),n=document.getElementById("merchant-email"),r=document.querySelector("#mob-container");if(n&&(n.innerHTML=this.email),this.isMobile){t&&t.setAttribute("src",S),r&&(r.innerHTML=this.mobileContainerContent());let i=document.querySelector(".mob-options");i&&this.viewMobileOptions(i);const A=document.querySelectorAll(".mob-tab-button");v.forEach((s,l)=>{const d=A[l];d&&(d.dataset.tab=l.toString(),d.addEventListener("click",()=>{this.setCurrentPaymentMethod(l)}))}),o&&this.currentPaymentMethod===3&&(o.classList.add("hidden"),o.classList.remove("md:hidden"))}else{e&&e.setAttribute("src",S);let i=document.querySelector(".payment-options");i&&(i.innerHTML=`<div> 
        ${v.map((s,l)=>`
              <div class="tab">   
      ...
      ${v.map((t,o)=>`
              ...
              `).join("")}`}cleanup(){this.transfer&&this.transfer.destroyTimer()}closeModal(){this.modalContainer&&this.modalContainer.parentNode&&document.body.removeChild(this.modalContainer)}}C.CheckoutForm=s1,Object.defineProperty(C,Symbol.toStringTag,{value:"Module"})});
