...
(function(w,m){typeof exports=="object"&&typeof module<"u"?module.exports=m():typeof define=="function"&&define.amd?define(m):(w=typeof globalThis<"u"?globalThis:w||self,w.SpotflowCheckout=m())})(this,function(){"use strict";var a1=Object.defineProperty;var o1=(w,m,g)=>m in w?a1(w,m,{enumerable:!0,configurable:!0,writable:!0,value:g}):w[m]=g;var o=(w,m,g)=>o1(w,typeof m!="symbol"?m+"":m,g);const w=`<div role="dialog" class="relative z-10" aria-labelledby="modal-title" aria-modal="true">
...
`,key:"ussd"}],X=[{name:"First City Monument Bank",code:"*329#"},{name:"First Bank",code:"*268#"}],B=[{name:"MasterCard",icon:`<svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</div>`,_=`<div id="trasferConfirmationOne">
    <div class="box-container">
...
`,e1=`<div id="trasferConfirmationProgress">
  <div class="box-container">
...
`;class s1{constructor(){o(this,"contents");o(this,"banks");o(this,"_currentStep");this.contents=document.querySelectorAll(".content"),this.banks=X,this._currentStep=1,this.renderUssdContent()}get currentStep(){return this._currentStep}set currentStep(e){this._currentStep=e,this.renderUssdContent()}getUssdStepContent(){switch(this.currentStep){case 1:return G;case 2:return A1;case 3:return R;case 4:return x;default:return G}}renderUssdContent(){this.contents[2]&&(this.contents[2].innerHTML=this.getUssdStepContent())}renderSearchOptions(e,t,n){n.innerHTML="",e.forEach(A=>{const s=document.createElement("div");s.classList.add("bank-option"),s.textContent=A.name,s.addEventListener("click",()=>{t.value=A.name,n.style.display="none"}),n.appendChild(s)}),n.style.display=e.length?"block":"none"}searchBanksOnInput(e,t){const n=e.value.toLowerCase(),A=this.banks.filter(s=>s.name.toLowerCase().includes(n));this.renderSearchOptions(A,e,t)}openSearchOnFocus(e,t){this.renderSearchOptions(this.banks,e,t)}closeSearchOptionsOutsideFocus(e,t,n){!t.contains(e.target)&&!n.contains(e.target)&&(n.style.display="none")}}class i1{constructor(e,t,n){o(this,"modalContainer");o(this,"currentPaymentMethod");o(this,"currentStep");o(this,"container");o(this,"card");o(this,"transfer");o(this,"ussd");o(this,"merchantKey");o(this,"email");o(this,"amount");o(this,"isMobile",!1);if(this.modalContainer=document.createElement("div"),this.modalContainer.innerHTML=w,document.body.appendChild(this.modalContainer),this.isMobile=window.matchMedia("(max-width: 767px)").matches,this.currentPaymentMethod=this.isMobile?3:0,this.currentStep=1,this.container=document.querySelectorAll(".content")[0],this.merchantKey=e,this.email=t,this.amount=n,this.attachInputListeners(),e===""||t==="")throw this.closeModal(),new Error("Merchant key or email is required")}attachInputListeners(){const e=document.body.querySelector("#change-method"),t=document.body.querySelectorAll(".close-btn"),n=document.querySelector("#mob-container"),A=document.querySelector("#mob-tab-co"),s=document.querySelector("#mob-tab-c");e&&(this.cleanup(),e.addEventListener("click",()=>{this.currentPaymentMethod=3,this.attachInputListeners(),n&&(n.innerHTML=this.mobileContainerContent()),this.setup(),A&&s&&s.parentNode&&A.removeChild(s)})),t.length>0&&t.forEach(i=>{i.addEventListener("click",()=>{this.cleanup(),this.closeModal()})})}displayTabLayout(){const e=document.querySelectorAll(".tab-button"),t=document.querySelectorAll(".mob-tab-button"),n=document.querySelector(".box-container-method"),A=document.querySelector("#mob-container"),s=document.querySelector("#inner-mob-container"),i=document.querySelector("#mob-tab-co");this.isMobile?t&&n&&A&&s&&t.forEach(c=>{c.addEventListener("click",a=>{if(a.currentTarget instanceof HTMLElement&&a.currentTarget.dataset.tab){const d=parseInt(a.currentTarget.dataset.tab);this.updatePaymentMethodView(this.merchantKey,this.email,this.amount),this.setCurrentPaymentMethod(d),A.removeChild(s),this.cleanup(),Q.forEach((l,h)=>{this.currentPaymentMethod===h&&i&&(i.innerHTML=`
                      ...
                      `)}),this.renderPaymentMethodContent(),this.attachInputListeners()}})}):e&&n&&e.forEach(c=>{c.addEventListener("click",a=>{if(a.currentTarget instanceof HTMLElement&&a.currentTarget.dataset.tab){const d=parseInt(a.currentTarget.dataset.tab);this.updatePaymentMethodView(this.merchantKey,this.email,this.amount),this.setCurrentPaymentMethod(d),this.cleanup(),this.renderPaymentMethodContent(),this.attachInputListeners()}})}),this.updatePaymentMethodView(this.merchantKey,this.email,this.amount),this.renderPaymentMethodContent(),this.attachInputListeners(),this.setCurrentPaymentMethod(this.currentPaymentMethod)}updatePaymentMethodView(e,t,n){switch(this.currentPaymentMethod){case 0:return this.card=new T(this.modalContainer,()=>this.closeModal(),e,t,n);case 1:return this.transfer=new n1(this.modalContainer,()=>this.closeModal(),e,t,n);case 2:return this.ussd=new s1;default:return this.card=new T(this.modalContainer,()=>this.closeModal(),e,t,n)}}renderPaymentMethodContent(){return(()=>{switch(this.currentPaymentMethod){case 0:return this.card.renderCardContent();case 1:return this.transfer.renderTransferContent();case 2:return this.ussd.renderUssdContent();case 3:return"";default:return this.card.renderCardContent()}})()}setCurrentPaymentMethod(e){this.currentPaymentMethod=e;const t=document.querySelectorAll(".tab-button");let n=document.querySelectorAll(".content");const A=document.getElementById("mob-action-btns");t.forEach(s=>s.classList.remove("active")),n.forEach(s=>s.classList.remove("active")),t[e]&&t[e].classList.add("active"),n[e]&&n[e].classList.add("active"),e!==3&&A&&(A.classList.remove("hidden"),A.classList.add("md:hidden"))}cleanup(){this.transfer&&this.transfer.destroyTimer()}closeModal(){this.modalContainer&&this.modalContainer.parentNode&&document.body.removeChild(this.modalContainer)}setup(){const e=document.getElementById("merchantLogo"),t=document.getElementById("merchantLogoMob"),n=document.getElementById("mob-action-btns"),A=document.getElementById("merchant-email"),s=this.modalContainer.querySelector("#paymentWarning"),i=s==null?void 0:s.querySelector("#payment-warning-text"),c=document.querySelector("#mob-container");if(A&&(A.innerHTML=this.email),this.isMobile){t&&t.setAttribute("src",m),c&&(c.innerHTML=this.mobileContainerContent());let a=document.querySelector(".mob-options");a&&this.viewMobileOptions(a);const d=document.querySelectorAll(".mob-tab-button");Q.forEach((l,h)=>{const p=d[h];p&&(p.dataset.tab=h.toString(),p.addEventListener("click",()=>{this.setCurrentPaymentMethod(h)}))}),n&&this.currentPaymentMethod===3&&(n.classList.add("hidden"),n.classList.remove("md:hidden"))}else{e&&e.setAttribute("src",m);let a=document.querySelector(".payment-options");a&&(a.innerHTML=`<div> 
        ${Q.map((l,h)=>`
              <div class="tab">   
      ...
      ${Q.map((t,n)=>`
              ...
              `).join("")}`}displayPaymentWarningText(e,t){const n=()=>{switch(e){case 0:return"Incorrect otp. please retry with the correct otp";case 1:return"Account expired";case 2:return"Please dial the ussd shortcode";default:return"Error"}};t&&(t.innerHTML=n())}}return i1});
